...
export default () => (
  <Slide bg="#ffc766">
    <img src="https://f1.codeday.org/gifs/helpcat.gif" alt="A cat cries help! in a tree." />
    ...
    <Title>Talk to us after, or visit: <FeaturedText>CodeDay.org/Volunteer</FeaturedText></Title>
  </Slide>
);
